...
class AnchorText(object):
    ...
    def explain_instance(self, text, classifier_fn, threshold=0.95,
        ...
        exp, exps, non_exps = anchor_base.AnchorBaseBeam.anchor_beam(
        ...
        for expl, cov in sorted_non_exps:
            ...
            expl['instance'] = text
            expl['prediction'] = true_label
            final_non_explanations.append(anchor_explanation.AnchorExplanation('text', expl,
                                                            self.as_html))
        return explanation, final_explanations, final_non_explanations
